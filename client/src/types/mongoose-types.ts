 ...
 */
export type ClientQuery = mongoose.Query<any, ClientDocument, ClientQueries> &
  ClientQueries;
 ...
 * ```
 */
export type ClientModel = mongoose.Model<ClientDocument, ClientQueries> &
  ClientStatics;
...
> &
  ProjectMethods & {
    ...
    description?: string;
    status?: "Not Started" | "In Progress" | "Completed";
    clientId?: ClientDocument["_id"] | ClientDocument;
    _id: mongoose.Types.ObjectId;
  };
