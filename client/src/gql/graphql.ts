...
export type PaginatedProjectsQuery = { paginatedProjects: { pageInfo: { page: number, hasNextPage: boolean, hasPrevPage: boolean }, projects: Array<{ id: string, name: string, status: string }> } | null };
